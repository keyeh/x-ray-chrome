...
exports.xRayChrome = function (options) {
    ...
    return function (ctx, done) { return __awaiter(_this, void 0, void 0, function () {
        var browser, page, _a, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Puppeteer.launch(launchOptions)];
                case 1:
                    browser = _b.sent();
                ...
                case 4:
                    _b.sent();
                    if (!(typeof cl === 'function')) return [3 /*break*/, 6];
                    return [4 /*yield*/, cl(page, ctx, navigationOptions)];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, page.goto(ctx.url, navigationOptions)];
                case 7:
                    _b.sent();
                    _b.label = 8;
                case 8:
